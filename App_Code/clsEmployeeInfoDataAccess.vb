...
Public Class clsEmployeeInfoDataAccess
    ...
    Public Function fnGetActiveEmpList(ByVal DepartmentID As String) As DataSet

        Dim sp As String = "spGetActiveEmpListByDept"
        Dim da As SqlDataAdapter = New SqlDataAdapter()
        Dim ds As DataSet = New DataSet()
        Try
            con.Open()
        ...
        Try
            ...
            Using cmd = New SqlCommand(sp, con)
                ...
                While dr.Read()
                    ...
                    EmpInfo.DepartmentID = dr.Item("DepartmentID")
