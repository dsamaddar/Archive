...
Partial Class frmUploadDocuments
    ...
    Protected Sub ListFileCategoriesForEmp(ByVal EmployeeID As String)
        Try
            ...
            drpFileCategory.DataSource = FileCategoryData.fnListFileCategories(EmployeeID)
    ...
    Protected Sub ListDepartments()
        Try
            ...
            drpCustodianDept.SelectedValue = Session("DepartmentID")
            drpCustodianDept.Enabled = False
        Catch ex As Exception
            MessageBox(ex.Message)
        End Try
    End Sub
    ...
    Protected Sub ListEmployees(ByVal DepartmentID As String)
        Try
            drpResponsiblePerson.DataTextField = "EmployeeName"
            drpResponsiblePerson.DataValueField = "EmployeeID"
            drpResponsiblePerson.DataSource = EmpData.fnGetActiveEmpList(DepartmentID)
            drpResponsiblePerson.DataBind()

            drpResponsiblePerson.SelectedValue = Session("EmployeeID")
    ...
    Protected Sub ListCabinetLocation(ByVal ULCBranchID As String)
        Try
            drpCabinetLocation.DataTextField = "CabinetLocation"
            drpCabinetLocation.DataValueField = "CabinetLocationID"
            drpCabinetLocation.DataSource = CabLocData.fnListCabinetLocations(ULCBranchID)
            drpCabinetLocation.DataBind()
        Catch ex As Exception
            MessageBox(ex.Message)
        End Try
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ListDepartments()
            ListEmployees(drpCustodianDept.SelectedValue)
            ListCabinetLocation(Session("ULCBranchID"))
