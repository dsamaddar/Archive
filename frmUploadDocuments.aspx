<%@ Page Language="VB" MasterPageFile="~/FileStorage.master" AutoEventWireup="false"
    ...
    Title=".:File Storage:." MaintainScrollPositionOnPostback="true" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="reqFldRefNo" runat="server" ControlToValidate="txtReferenceNo"
                                    ErrorMessage="*" ValidationGroup="upDoc" CssClass="RequiredLabel"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 20px">
            ...
            <td>
                <asp:Panel ID="pnlUploadedDocuments" runat="server" SkinID="pnlInner">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td>
                                <div id="dvScroll_d" style="max-height: 200px; max-width: 100%; overflow: auto">
